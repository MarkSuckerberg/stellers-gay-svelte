/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cdb16acdf6696669649f648828caf861)
// Runtime types generated with workerd@1.20260623.1 2026-02-05 nodejs_als
interface __BaseEnv_Env {
	DB: D1Database;
	RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	PUBLIC_MATRIX_URL: string;
	PUBLIC_PDS_URL: string;
	PUBLIC_AUTH_ISSUER_URL: string;
	PUBLIC_AKKOMA_URL: string;
	TURNSTILE: string;
